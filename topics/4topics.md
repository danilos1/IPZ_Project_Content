...
IDE загружає проект(який може складатися з багатьох файлів), дозволяє переключатися між файлами, пропонує автодоповнення по коду всього проету (а не тільки откритого файлу), також вона інтегрована з систомою контроля версій (наприклад, такої як git), середою для тестування і другими інструментами на рівні всього проекту.
